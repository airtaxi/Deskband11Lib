...
{
    private readonly Control _contentElement;

    public TaskbarContentHost(Window window, Control contentElement) : this(window, contentElement, null) { }

    public TaskbarContentHost(Window window, Control contentElement, TaskbarContentHostOptions? options = null) : this(contentElement, CreateConstructionState(window, contentElement, options)) { }

    private TaskbarContentHost(Control contentElement, TaskbarContentHostConstructionState constructionState) : base(constructionState.PlatformAdapter, constructionState.Options)
    {
    ...
    private static TaskbarContentHostConstructionState CreateConstructionState(Window window, Control contentElement, TaskbarContentHostOptions? options)
    {
